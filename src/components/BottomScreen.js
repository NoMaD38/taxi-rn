...
const SCREEN_HEIGHT = ( Dimensions.get('window').height - StatusBar.currentHeight ) * 0.55;
...
export default ({children, bottomContent, minHeight, maxHeight, autoHeight, initialHeight, withPadding, setInterface}) => {
