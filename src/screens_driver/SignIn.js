  ...
  return (
    <Screen withoutHeader>
      ...
      <View style={style.button}>
        <Button
          disabled={!phone.trim()}
          onClick={() => navigation.push('main_driver')}>
          Далее
        </Button>
      </View>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('signup_driver')}>
      ...
      {Platform.OS == 'ios' ? (
        ...
        onPress={() => navigation.navigate('touchid-activate_driver')}>
      ...
      <TouchableOpacity
        style={style.altSignin}
        onPress={() => navigation.navigate('faceid-activate_driver')}>
